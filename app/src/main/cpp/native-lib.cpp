...
extern "C" JNIEXPORT jstring JNICALL
Java_id_ac_ui_cs_mobileprogramming_lab_shafira_helloworld_MainActivity_sendYourName(
        JNIEnv* env,
...
extern "C"
JNIEXPORT jobjectArray JNICALL Java_id_ac_ui_cs_mobileprogramming_lab_shafira_helloworld_MainActivity_stringArrayFromJNI(JNIEnv *env, jobject jobj)
{
